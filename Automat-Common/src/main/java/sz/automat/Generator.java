...
public class Generator {
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://127.0.0.1:3306/automat?characterEncoding=utf8");
		...
		// 自定义实体父类
		strategy.setSuperEntityClass("sz.automat.core.base.BaseModel");
		// 自定义实体，公共字段
		strategy.setSuperEntityColumns(
				new String[] { "id_", "enable_", "remark_", "create_by", "create_time", "update_by", "update_time" });
		// 自定义 mapper 父类
		strategy.setSuperMapperClass("sz.automat.core.base.BaseMapper");
		// 自定义 service 父类
		strategy.setSuperServiceClass("sz.automat.core.base.BaseService");
		// 自定义 service 实现类父类
		strategy.setSuperServiceImplClass("sz.automat.core.base.BaseService");
		// 自定义 controller 父类
		strategy.setSuperControllerClass("sz.automat.core.base.AbstractController");
		...
		InjectionConfig cfg = new InjectionConfig() {
			public void initMap() {
				...
				map.put("providerClassPackage", "sz.automat.provider.ISysProvider");
				this.setMap(map);
			}
		};
		mpg.setCfg(cfg);
